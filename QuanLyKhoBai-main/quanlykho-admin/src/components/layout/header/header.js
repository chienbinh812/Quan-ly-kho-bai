...
function Topbar() {
  ...
  return (
    ...
    >
      <div >
        <Row className="header" style={{ background: "#FFFFFF", paddingTop: 6, paddingBottom: 6, top: 0, position: 'fixed', left: 0, display: 'flex', width: '100%', padding: 0, zIndex: 2, justifyContent: 'center', alignItems: 'center'}}>
          <Col span={10}>
            <div style={{ position: 'relative', display: 'flex', alignItems: "center", marginLeft: 8 }}>
              ...
              >
                <Col style={{ paddingLeft: 20 }}>
                  <a href="#">
                    <img className="logo" alt="" src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/fe/Viettel_logo_2021.svg/256px-Viettel_logo_2021.svg.png"/>
                  </a>
                </Col>
              </Row>
            </div>
